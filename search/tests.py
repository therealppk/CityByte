...
import pytz
from info.models import CitySearchRecord, Comment, FavCityEntry
...
class CityByte_testcase(TestCase):
    ...
    def test_info_page(self):
        ...
        if not weather_info and not dining_info and not outdoor_info and not airport_info and not arts_info and not photo_link:
            assert True
